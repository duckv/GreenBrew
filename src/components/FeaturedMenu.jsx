 ...
 * Displays popular menu items with customization and cart functionality
 */
...
/**
 * Individual featured item card component
 ...
 * @returns {JSX.Element} Menu item card with customization
 */
function FeaturedItemCard({ item, quantity, onUpdateQuantity, onAddToCart }) {
...
/**
 * Featured menu section component
 * @returns {JSX.Element} Featured menu section with items
 */
export default function FeaturedMenu() {
  ...
  /**
   * Handles view full menu button click
   * Checks for existing user info or shows location modal
   */
