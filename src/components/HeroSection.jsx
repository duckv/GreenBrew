 ...
 * Main banner section with location modal and menu navigation
 */
 ...
 * @returns {JSX.Element} Hero section with navigation options
 */
export default function HeroSection() {
  ...
  /**
   * Handles menu view button click
   * Checks for existing user location or shows location modal
   */
