 ...
 * Handles pickup/delivery selection and user information collection
 */
...
/**
 * Location modal for order type selection and user info collection
...
export default function LocationModal({ isOpen, onClose }) {
  ...
  /**
   * Validates form completeness based on selected option
  ...
  /**
   * Handles external delivery service selection
   * @param {string} service - Delivery service name
   */
  const handleDeliveryService = (service) => {
  ...
  // Show delivery service selection if delivery option is selected and user info is provided
