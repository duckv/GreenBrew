/**
 * Footer component with site links and contact information
 * Complete footer with business hours, contact info, and social links
 */
...
/**
 * Main footer component with comprehensive site information
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} Bread N' Br☕︎w. All rights reserved.
            </p>
