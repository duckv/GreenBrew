 ...
 * Floating cart button and overlay accessible from all pages
 */
...
/**
 * Global floating cart component with button and overlay
 * @returns {JSX.Element} Floating cart interface
 */
    ...
    <>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        ...
        >
          ...
          <Badge className="absolute -top-2 -right-2 bg-brand-pink text-white text-xs h-6 w-6 rounded-full flex items-center justify-center p-0">
            {totalItems}
          </Badge>
        </Button>
      </div>
