 ...
 * Complete checkout process with cart review, payment, and order placement
 */
...
/**
 * Checkout page component with payment processing and order management
 * @returns {JSX.Element} Complete checkout page
 */
export default function Checkout() {
  ...
  // Load user information and validate cart on component mount
  useEffect(() => {
  ...
  /**
   * Calculates tax amount (6.625% NJ sales tax)
  ...
  /**
   * Calculates delivery fee if applicable
  ...
  /**
   * Calculates tip amount based on percentage or custom amount
