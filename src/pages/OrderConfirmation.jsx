 ...
 * Displays order details, status, and receipt after successful checkout
 */
...
/**
 * Order confirmation page component
 * @returns {JSX.Element} Order confirmation page with receipt and status
 */
export default function OrderConfirmation() {
  ...
  /**
   * Calculates estimated ready time (20 minutes from order time)
...
Thank you for your order!
  ...
  // Show loading if order not loaded
  if (!order) {
